...
```{r plot horses, fig.height=3, fig.width=10, fig.cap="Figure 1. Horse populations for all provinces in Canada between 1940 - 1972."}
...
<!-- Figure 1. Horse populations for all the provinces between 1940 - 1972. -->
